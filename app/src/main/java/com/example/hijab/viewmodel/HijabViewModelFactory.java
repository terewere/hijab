...
@Singleton
public final class HijabViewModelFactory implements ViewModelProvider.Factory {

    private Map<Class<? extends ViewModel>, Provider<ViewModel>> creators;

    @Inject
    HijabViewModelFactory(final Map<Class<? extends ViewModel>, Provider<ViewModel>> creators) {
