...
public abstract class HijabDB2 extends RoomDatabase {

    private static final String DB_NAME = "hijabDatabase.db";
    private static volatile HijabDB2 instance;

    public static synchronized HijabDB2 getInstance(Context context) {
        if (instance == null) {
    ...
    private static HijabDB2 create(final Context context) {
